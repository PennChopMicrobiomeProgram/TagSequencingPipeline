...
### setwd
opts_knit$set(root.dir = "/media/lorax/users/danielsg/usda_tutorial")

### mapping file path
mapping_file_fp <- file.path("288.txt")
...
<!-- Output -->
<!-- ------------------------------------------------- -->
<!--       SampleID          SampleType     isControl  -->
<!-- -------------------- ---------------- ----------- -->
<!--  DNACleanupControl2   DNA Cleanupneg     FALSE    -->

<!--  DNACleanupControl4   DNA Cleanupneg     FALSE    -->
<!-- ------------------------------------------------- -->

<!-- Table: These samples were in the sample sheet but not in the feature table. -->
<!-- And they are actually control so this is ok -->
